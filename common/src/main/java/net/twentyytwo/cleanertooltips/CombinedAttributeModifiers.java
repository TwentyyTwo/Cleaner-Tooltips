...
public record CombinedAttributeModifiers(Multimap<String, Entry> modifiers) {
    ...
    private static final Identifier SHARPNESS_BONUS_ID = CleanerTooltips.location("sharpness_bonus_damage");
    private static final Identifier BASE_ENTITY_REACH_ID = Identifier.withDefaultNamespace("base_entity_reach");
    ...
    public static CombinedAttributeModifiers fromStack(ItemStack stack,
        ...
        for (EquipmentSlotGroup slot : EquipmentSlotGroup.values()) {
            ...
            stack.forEachModifier(slot, (k, v, d) -> {
    ...
    public static class Merger {
        static final Identifier MERGED_ID = CleanerTooltips.location("merged_modifier");
